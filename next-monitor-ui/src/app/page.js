        ...
        <div className="min-h-screen bg-slate-950 text-slate-50 font-sans relative overflow-x-hidden selection:bg-blue-500/30">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <header className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-10 pb-6 border-b border-white/10">
                    <div>
                        <h1 className="text-3xl font-bold bg-gradient-to-r from-emerald-400 to-blue-500 bg-clip-text text-transparent flex items-center gap-3">
                            ...
                            WA API Central Monitor
                        </h1>
                        <p className="text-slate-400 mt-2 text-sm">Real-time status monitoring untuk WhatsApp Gateway API</p>
                    </div>
